const Static = {
  perks: {
    ...
    stakeout: {
      ...
      tip:
        'Stake Out gains 1 Token, up to a maximum of 2/3/4 Tokens.\n'
  ...
  effects: {
    ...
    correctiveaction: {
      ...
      tip:
        'You start the Trial with 3 Tokens on Corrective Action and gain +1 Token each time you succeed at a Great Skill Check, up to a maximum of 5 Tokens.\n'
